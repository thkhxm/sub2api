export default {
  ...
  admin: {
    ...
    settings: {
      ...
      imWebhook: {
        title: 'IM 通知配置',
        description: '配置即时通讯 webhook 渠道（飞书 / 企业微信 / Telegram），用于推送账号失效、重授权等通知。',
        enableLabel: '启用 IM 通知',
        enableHint: '总开关。关闭后所有渠道都不会发送通知。',
        channels: '通知渠道',
        noChannels: '暂无渠道，点击下方按钮添加。',
        addChannel: '添加渠道',
        channelType: '渠道类型',
        channelEnabled: '启用',
        types: {
        ...
        url: 'Webhook 地址',
        secret: '签名密钥（飞书）',
        secretPlaceholder: '可选，飞书机器人开启签名校验时填写',
        secretHint: '仅当飞书机器人启用了「签名校验」时需要填写。',
        telegramBotToken: 'Bot Token',
        telegramChatId: 'Chat ID',
        sendTest: '发送测试',
        testing: '发送中…',
        testTitle: 'IM 通知测试',
        testText: '这是一条来自 Sub2API 的测试通知，如果你能看到说明配置成功。',
        testSuccess: '测试通知已发送，请检查对应的 IM 群。',
        testFailed: '测试通知发送失败，请检查渠道配置。',
        saveSuccess: 'IM 通知配置已保存',
        saveFailed: '保存 IM 通知配置失败',
        loadFailed: '加载 IM 通知配置失败',
      },
      features: {
        channelMonitor: {
          title: '渠道监控',
