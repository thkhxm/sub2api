...
// normalizeOpenAIResponsesCompactRequest 保留 Codex remote_compaction_v2 的
// 原生流式 /responses 协议；未显式声明该协议的旧 body-signal 客户端仍提升到
// /responses/compact，并继续使用 unary-to-SSE 兼容桥。
