...
func TestGatewayModels_OpenAICustomModelsListKeepsSelectedDefaultModelWithoutAccountMapping(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestGatewayModels_OpenAICustomModelsListIncludesSelectedDefaultModelsWithAccountMapping(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	c.Set(string(middleware2.ContextKeyAPIKey), &service.APIKey{
		Group: &service.Group{
			...
			ModelsListConfig: service.GroupModelsListConfig{
				Enabled: true,
				Models:  []string{"gpt-6-astra", "gpt-6", "gpt-5.6-sol", "gpt-5.6", "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.5", "gpt-image-2"},
			},
		},
	})
	...
	require.NoError(t, json.Unmarshal(rec.Body.Bytes(), &got))
	require.Equal(t,
		[]string{"gpt-6-astra", "gpt-6", "gpt-5.6-sol", "gpt-5.6", "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.5", "gpt-image-2"},
