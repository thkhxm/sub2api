...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/vpn', label: t('vpn.title'), icon: GlobeIcon },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/vpn', label: t('vpn.adminTitle'), icon: ServerIcon },
    ...
    { path: '/admin/balance-requests', label: t('nav.balanceRequests'), icon: CreditCardIcon, hideInSimpleMode: true },
    {
