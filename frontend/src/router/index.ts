...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/account/reauth',
    name: 'AccountReauthSelfService',
    component: () => import('@/views/account/ReauthSelfServiceView.vue'),
    meta: {
      requiresAuth: false,
      title: 'Account Re-authorization',
      titleKey: 'accountReauth.pageTitle'
    }
  },
  ...
  },
  {
    ...
    name: 'AdminBalanceRequests',
    component: () => import('@/views/admin/BalanceRequestsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Balance Request Approval',
      titleKey: 'admin.balanceRequests.title',
      descriptionKey: 'admin.balanceRequests.description'
    }
  },
  {
    path: '/admin/settings',
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/key-usage', '/setup', '/payment/result', '/payment/airwallex', '/legal', '/account/reauth']
