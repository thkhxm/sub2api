export default {
  vpn: {
    ...
    usageProgress: '{used} used of {quota} monthly quota, {percent}',
    sort: 'Sort', sortNewest: 'Newest first', sortUsageDesc: 'Traffic used: high to low', sortUsageAsc: 'Traffic used: low to high',
    ...
    createHint: 'Automatically selects a healthy, enabled server with enough allocatable quota and the lowest allocation ratio. Administrator activation does not require a positive balance. An existing subscription is returned unchanged.',
    ...
    retry: 'Retry original operation', revoke: 'Choose server and rotate', revokeConfirm: 'Rotate credentials on the current server “{name}” without reserving extra quota. Usage in the current period is preserved. The old subscription URL and credentials become invalid and old connections are disconnected. All devices belonging to this user must import the subscription again. Continue?',
    revokeMigrateConfirm: 'Move this subscription to “{name}” and preserve usage in the current period. The old subscription URL and credentials become invalid and old connections are disconnected. All devices belonging to this user must import the subscription again. Continue?',
    selectRotationServer: 'Choose destination server', currentServer: 'Current server',
    selectRotationServerHint: 'Select a server manually. Choose the current server to rotate in place or another server to migrate. Allocation uses the sum of limited accounts’ monthly quotas, including pending reservations, without subtracting usage. Unlimited operations accounts are excluded. Migration reserves the full monthly quota; capacity is checked again on submission.',
    allocatedQuota: 'Allocated quota', allocatableQuota: 'Allocatable quota', insufficientAllocation: 'Insufficient allocatable quota', unknownAllocation: 'Capacity is not confirmed. Refresh the status.',
    noRotationServer: 'No server is selectable. Check server health and allocatable quota.',
