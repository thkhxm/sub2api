export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      owner: {
        title: 'Owner',
        hint: 'When an owner is set, a re-authorization link is sent to them (email / IM) once the account is revoked.',
        email: 'Owner email',
        emailPlaceholder: 'owner@example.com',
        name: 'Owner name',
        namePlaceholder: 'Optional, used as the addressee in notifications',
        userId: 'Owner user ID',
        userIdPlaceholder: 'Optional, link to a local user ID',
      },
      allPlatforms: 'All Platforms',
      allTypes: 'All Types',
      allStatus: 'All Status',
    ...
    settings: {
      ...
      imWebhook: {
        title: 'IM Notification Settings',
        description: 'Configure instant-messaging webhook channels (Feishu / WeCom / Telegram) for notifications such as account failures and re-authorization.',
        enableLabel: 'Enable IM notifications',
        enableHint: 'Master switch. When off, no channel will send notifications.',
        channels: 'Notification channels',
        noChannels: 'No channels yet. Click the button below to add one.',
        ...
        url: 'Webhook URL',
        secret: 'Sign secret (Feishu)',
        secretPlaceholder: 'Optional, required when the Feishu bot has signature verification on',
        secretHint: 'Only needed when the Feishu bot has "signature verification" enabled.',
        telegramBotToken: 'Bot Token',
        telegramChatId: 'Chat ID',
        sendTest: 'Send test',
        testing: 'Sending…',
        testTitle: 'IM Notification Test',
        testText: 'This is a test notification from Sub2API. If you see this, your configuration works.',
        testSuccess: 'Test notification sent. Please check the corresponding IM group.',
        testFailed: 'Failed to send test notification. Please check the channel configuration.',
        saveSuccess: 'IM notification settings saved',
        saveFailed: 'Failed to save IM notification settings',
        loadFailed: 'Failed to load IM notification settings',
      },
      features: {
        channelMonitor: {
          title: 'Channel Monitor',
